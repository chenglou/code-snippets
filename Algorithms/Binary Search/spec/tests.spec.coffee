binarySearches = require '../'
iterativeBinarySearch = binarySearches.iterativeBinarySearch
recursiveBinarySearch = binarySearches.recursiveBinarySearch
continuationBinarySeach = binarySearches.continuationBinarySeach
